...
import { experiences, skillGroups, stats } from '../data/portfolio'

function Home() {
  return (
    <main className="mx-auto max-w-280 px-5 pb-16 pt-6 sm:px-8 lg:px-10 lg:pb-20">
      <section className="grid gap-12 pb-16 pt-10 md:grid-cols-[1.15fr_0.85fr] md:items-start md:pt-12">
        <ScrollReveal className="space-y-10" from="left" delay={40}>
          <div className="space-y-5">
            ...
            <p className="max-w-135 text-[13px] leading-6 text-[#a9a9a9] sm:text-[14px]">
              Hi! I am Jeremy. A Frontend Web Developer based in Vietnam. With over 1 year of experience, I help people
              to grow their business by providing powerful and modern Web solutions.
            </p>
            <a
      ...
      <section className="border-t border-white/10 py-14">
        <div className="grid gap-8 md:grid-cols-[0.95fr_1.05fr] md:items-start">
          <ScrollReveal from="left" delay={40}>
          ...
          <div className="max-w-107.5 space-y-5 text-[13px] leading-7 text-[#c2c2c2] sm:text-[14px]">
            <ScrollReveal delay={120}>
              <p>
                I&apos;m a 21 years-old passionate frontend web developer dedicated to turning ideas into creative solutions.
      ...
      <section className="py-20">
        ...
        <div className="space-y-8">
          {experiences.map((item, index) => (
            <ScrollReveal key={`${item.company}-${item.role}`} delay={index * 120}>
