	...
	return (
		<main className="relative min-h-screen bg-[var(--bg)] text-[#e6e6e6]">
			...
			<section className="relative snap-start px-5 pt-6 sm:px-8 sm:pt-8 lg:px-10">
				<div className="mx-auto grid min-h-[100svh] max-w-360 items-center justify-items-center gap-6 py-8 sm:gap-8 sm:py-10 md:gap-10 md:py-12 lg:max-w-[61rem] lg:grid-cols-[minmax(0,1fr)_minmax(18rem,21rem)] lg:gap-10 lg:py-0 xl:max-w-[72rem] xl:grid-cols-[minmax(0,1fr)_minmax(21rem,25rem)] xl:gap-12 xl:-translate-y-3 2xl:max-w-[86rem] 2xl:grid-cols-[minmax(0,0.98fr)_minmax(0,1.02fr)] 2xl:gap-14 2xl:-translate-y-4">
			...
			<section id="featured-projects" className="relative snap-start px-5 pt-6 sm:px-8 sm:pt-8 lg:px-10">
				<div className="mx-auto max-w-360 gap-6 py-8 sm:gap-8 sm:py-10 md:gap-10 md:py-12 lg:max-w-[61rem] xl:max-w-[72rem] 2xl:max-w-[86rem] ">
					<ScrollReveal>
			...
			<section className="relative px-5 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12">
				<div className="mx-auto max-w-360 lg:max-w-[61rem] xl:max-w-[72rem] 2xl:max-w-[86rem]">
					<ScrollReveal>
