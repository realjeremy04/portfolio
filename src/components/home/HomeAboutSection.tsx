...
const HomeAboutSection = memo(function HomeAboutSection({ sectionRef }: HomeSectionProps) {
  return (
    ...
    >
      <div className="mx-auto grid min-h-[100svh] max-w-360 items-center justify-items-center gap-4 py-8 sm:gap-[1.125rem] sm:py-10 md:gap-5 md:py-12 lg:max-w-[61rem] lg:grid-cols-[minmax(0,1fr)_minmax(18rem,21rem)] lg:items-center lg:justify-items-center lg:gap-10 lg:py-0 xl:max-w-[72rem] xl:grid-cols-[minmax(0,1fr)_minmax(21rem,25rem)] xl:gap-12 xl:-translate-y-3 2xl:max-w-[86rem] 2xl:grid-cols-[minmax(0,0.98fr)_minmax(0,1.02fr)] 2xl:gap-14 2xl:-translate-y-4">
        <ScrollReveal className="order-2 w-full max-w-[21.5rem] space-y-3.5 sm:max-w-[26rem] sm:space-y-4 md:max-w-[31rem] lg:order-1 lg:max-w-[26.5rem] lg:space-y-5 lg:self-center xl:max-w-[30rem] xl:space-y-6" from="left">
          <SectionHeading title="About Me" eyebrow="WHO I AM" animateItems compact framedTitle hideEyebrowOnMobile className="relative z-10 -mt-10 ml-3 sm:-mt-12 sm:ml-4 md:-mt-14 md:ml-5 lg:mt-0 lg:ml-0" />
        ...
        <ScrollReveal className="order-1 w-full max-w-[21.5rem] justify-self-center sm:max-w-[26rem] md:max-w-[31rem] lg:order-2 lg:max-w-[19rem] xl:max-w-[23.5rem] 2xl:max-w-[34rem]" from="right" delay={16}>
